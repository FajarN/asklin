...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Pembayaran Uang Pangkal</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('dashboard.index') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Pembayaran Uang Pangkal</div>
            </div>
        </div>
    </section>
    <div class="row">
                ...
                <div class="card-header">
                    <h4>
                        <a href="javascript:void(0)" onclick="add()" class="btn btn-icon icon-left btn-danger btn-outline-secondary">
                            <i class="fas fa-plus"></i> Tambah Pembayaran Uang Pangkal
                        </a>
                    </h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" id="id_kategori" name="id_kategori">
                                <option value="2">Uang Pangkal</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Status</label>
...
$(function () {
    var table = $('#table').DataTable({
        ...
        searching: false,
        ajax: { 
            url: "{{ route('pembayaran.list_pangkal') }}",
            data: function (d) {
                d.search = $('#search').val()
            }
        },
