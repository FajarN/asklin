            ...
            <div class="row justify-content-center text-center py-5">
                <div class="col-lg-8">
                    <div class="hero-content text-white">
                        ...
                        <div class="hero-stats d-flex justify-content-center gap-4 animate-fade-up"
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        @if (request('kategori'))
                            <span class="badge bg-info">
                                ...
                                <a href="{{ request()->fullUrlWithQuery(['kategori' => '']) }}"
                    ...
                    @forelse($event as $item)
                        <div class="col-lg-4 col-md-6 event-item">
                            <div class="event-card h-100">
                                <!-- Card Image -->
                                <div class="portfolio-single-image masonry-thumbs grid-container grid-4" data-big="3"
                                    data-lightbox="gallery">
                                    @if ($item->gambar)
                                        <a href="{{ route('event_asklin.detail', $item->path) }}"><img
                                                src="{{ asset('assets/images/events/' . $item->gambar) }}"
                                                class="card-img-top" alt="{{ $item->judul }}"></a>
                                    @else
                    ...
                    @empty
                        <div class="col-12">
                            <div class="empty-state text-center py-5">
                                ...
                                @if (request('search') || request('kategori') || request('status'))
                                    <p class="text-muted mb-4">Tidak ada event yang sesuai dengan kriteria pencarian Anda.
                                    </p>
                                    <a href="{{ route('event_asklin') }}" class="btn btn-primary">
                                        <i class="icon-refresh me-2"></i>Lihat Semua Event
                                    </a>
                                @else
                                    <p class="text-muted mb-4">Belum ada event yang tersedia saat ini. Silakan cek kembali
                                        nanti.</p>
