        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('anggota.index') }}">Detail Anggota</a>
                    </div>
            ...
            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-5">
                    <div class="card profile-widget">
                        ...
                        <form action="{{ route('anggota.update_anggota', $anggota->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <table class="table">
                                <thead>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            var table1 = $('#table1').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.pjk', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table2 = $('#table2').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.dp', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table3 = $('#table3').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.tk', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table4 = $('#table4').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.tkl', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table5 = $('#table5').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.lain', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table6 = $('#table6').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.rumah_sakit', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table7 = $('#table7').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.asuransi', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
        ...
        $(function() {
            var table8 = $('#table8').DataTable({
                ...
                searching: false,
                ajax: {
                    url: "{{ route('anggota.sdm.foto', $anggota->id) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
